        ...
        <div className="flex justify-between items-center self-stretch">
          <button
            ...
            className={`flex flex-1 justify-center items-center gap-2 ${
              activeTab === '문제집' ? 'border-b border-[#0D6EFD]' : 'border-b border-[#E8F0FF]'
            } py-3`}
          >
            <span
          ...
          <button
            ...
            className={`flex flex-1 justify-center items-center gap-2 ${
              activeTab === '캠페인' ? 'border-b border-[#0D6EFD]' : 'border-b border-[#E8F0FF]'
            } py-3`}
          >
            <span
              className={`text-base font-semibold leading-[130%] tracking-[-0.16px] ${
          ...
          <button
            ...
            className={`flex flex-1 justify-center items-center gap-2 ${
              activeTab === '그룹방' ? 'border-b border-[#0D6EFD]' : 'border-b border-[#E8F0FF]'
            } py-3`}
          >
            <span
              className={`text-base font-semibold leading-[130%] tracking-[-0.16px] ${
