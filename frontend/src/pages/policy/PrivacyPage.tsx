                ...
                <div className="bg-white rounded-xl border border-gray-100 p-8 shadow-sm">
                    <div className="prose max-w-none text-gray-600 space-y-8">
                        ...
                        <section>
                            ...
                            <p>
                                알고가자(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제2조(개인정보 처리의 원칙)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제3조(본 방침의 공개)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제4조(본 방침의 변경)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제5조(회원 가입을 위한 정보)</h2>
                            <p>회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.</p>
                            <ol className="list-decimal pl-5 mt-2">
                                <li>필수 수집 정보: 이메일 주소, 비밀번호 및 닉네임</li>
                            </ol>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제6조(본인 인증을 위한 정보)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제7조(회사 서비스 제공을 위한 정보)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제9조(개인정보 수집 방법)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제10조(개인정보의 이용)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제11조(개인정보의 보유 및 이용기간)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제12조(법령에 따른 개인정보의 보유 및 이용기간)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제13조(개인정보의 파기원칙)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제14조(개인정보파기절차)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제15조(개인정보파기방법)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제16조(광고성 정보의 전송 조치)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제17조(개인정보 조회 및 수집동의 철회)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제18조(개인정보 정보변경 등)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제19조(이용자의 의무)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제20조(회사의 개인정보 관리)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제21조(삭제된 정보의 처리)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제22조(비밀번호의 암호화)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제23조(해킹 등에 대비한 대책)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제24조(개인정보 처리 최소화 및 교육)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제25조(개인정보 유출 등에 대한 조치)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제26조(개인정보 유출 등에 대한 조치의 예외)</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제27조(국외 이전 개인정보의 보호)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                                <li>회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지 않습니다.</li>
                                <li>회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를 포함)ㆍ처리위탁ㆍ보관(이하 "이전"이라 함)하려면 이용자의 동의를 받습니다. 다만, 본조 제3항 각 호의 사항 모두를 개인정보보호법 등 관계 법규에 따라 공개하거나 전자우편 등 대통령령으로 정하는 방법에 따라 이용자에게 알린 경우에는 개인정보 처리위탁ㆍ보관에 따른 동의절차를 거치지 아니할 수 있습니다.</li>
                                <li>회사는 본조 제2항 본문에 따른 동의를 받으려면 미리 다음 각 호의 사항 모두를 이용자에게 고지합니다.
                                    <ul className="list-[lower-alpha] pl-5 mt-1 space-y-1">
                                        <li>이전되는 개인정보 항목</li>
                                        <li>개인정보가 이전되는 국가, 이전일시 및 이전방법</li>
                                        <li>개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및 정보관리 책임자의 연락처를 말한다)</li>
                                        <li>개인정보를 이전받는 자의 개인정보 이용목적 및 보유ㆍ이용 기간</li>
                                    </ul>
                                </li>
                                <li>회사는 본조 제2항 본문에 따른 동의를 받아 개인정보를 국외로 이전하는 경우 개인정보보호법 대통령령 등 관계법규에서 정하는 바에 따라 보호조치를 합니다.</li>
                            </ol>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제28조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제29조(쿠키 설치 허용 지정 방법)</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 mb-3">제30조(권익침해에 대한 구제방법)</h2>
                            <ol className="list-decimal pl-5 space-y-2">
                                <li>정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.
                                    <ul className="list-[lower-alpha] pl-5 mt-1 space-y-1">
                                        <li>개인정보분쟁조정위원회 : (국번없이) 1833-6972 (<a href="http://www.kopico.go.kr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">www.kopico.go.kr</a>)</li>
                                        <li>개인정보침해신고센터 : (국번없이) 118 (<a href="http://privacy.kisa.or.kr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">privacy.kisa.or.kr</a>)</li>
                                        <li>대검찰청 : (국번없이) 1301 (<a href="http://www.spo.go.kr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">www.spo.go.kr</a>)</li>
                                        <li>경찰청 : (국번없이) 182 (<a href="http://ecrm.cyber.go.kr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">ecrm.cyber.go.kr</a>)</li>
                                    </ul>
                                </li>
                                <li>회사는 정보주체의 개인정보자기결정권을 보장하고, 개인정보침해로 인한 상담 및 피해 구제를 위해 노력하고 있으며, 신고나 상담이 필요한 경우 제1항의 담당부서로 연락해주시기 바랍니다.</li>
                                <li>개인정보 보호법 제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대 하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.
                                    <ul className="list-[lower-alpha] pl-5 mt-1">
                                        <li>중앙행정심판위원회 : (국번없이) 110 (<a href="http://www.simpan.go.kr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">www.simpan.go.kr</a>)</li>
                                    </ul>
                                </li>
                            </ol>
                        </section>
