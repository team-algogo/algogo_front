...
export default function ProblemStatisticsPage() {
    ...
    const { data: statisticsData } = useQuery({
        ...
        queryFn: () => getProblemStatistics(id, {
            page: page - 1,
            size: itemsPerPage,
            // Temporarily removed filters as per user request to simplify API call due to backend issues
            // keyword,
    ...
    return (
        <BasePage>
            <div className="mx-auto flex h-full w-full max-w-[1200px] flex-col items-start gap-10 bg-white p-[40px_0px_80px]">
                {/* Header */}
                ...
                <div className="flex w-full flex-row gap-8">
                    ...
                    <div className="w-[280px] shrink-0 flex flex-col gap-4">
                        <div className="flex flex-col w-full rounded-[12px] bg-white border border-[#F4F4F5] p-6 shadow-sm">
                            <h3 className="text-[18px] font-bold mb-4 text-[#333333]">통계 · 전체</h3>
                            <div className="flex flex-col gap-3">
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-600">제출 인원</span>
                                    <span className="font-medium text-[#333333]">{totalSubmissions.toLocaleString()}명</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-600">정답 인원</span>
                                    <span className="font-medium text-[#333333]">- 명</span>
                                </div>
                                <div className="flex justify-between items-center border-t border-gray-100 pt-3 mt-1">
                                    <span className="text-gray-600">정답률</span>
                                    <span className="font-bold text-[#0D6EFD]">- %</span>
                                </div>
                            </div>
                        </div>
                    </div>
