...
export default function SearchPage() {
    ...
    return (
        <>
            <Header />
            {/* Container */}
            <div className="flex flex-col items-center p-[16px_0px] gap-[24px] w-[1440px] max-w-[1440px] min-h-[790px] mx-auto bg-white">

                {/* SearchBox Area */}
                <div className="flex flex-col items-start p-2 gap-2 w-[684px] h-[52px] flex-none order-0 flex-grow-0">
                    <div className="flex flex-row justify-between items-center p-0 gap-[75px] w-full max-w-[800px] h-[36px] bg-white border border-[#30AEDC] rounded-[8px] flex-none order-0 self-stretch flex-grow-0 overflow-hidden">
                        <input
                            type="text"
                            value={inputValue}
                        ...
                        <button
                            ...
                            className="flex flex-row justify-center items-center w-[36px] h-[36px] bg-[#30AEDC] flex-none order-1 self-stretch flex-grow-0 hover:bg-[#2090BE] transition-colors"
                        >
                            <img
                ...
                {/* Content Area */}
                <div className="flex flex-row items-start p-0 gap-[32px] w-full flex-1 flex-none order-1 self-stretch flex-grow-1">
